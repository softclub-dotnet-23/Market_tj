...
namespace MarketTJ.Infrastructure.Migrations
{
    ...
    [Migration("20260807164005_AddOrderCancellationAndAccountBlock")]
    partial class AddOrderCancellationAndAccountBlock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketTJ.Domain.Entities.AccountBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("UserId", "BlockedUntil");

                    b.ToTable("AccountBlocks");
                });

            modelBuilder.Entity("MarketTJ.Domain.Entities.AiConversationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MarketTJ.Domain.Entities.Delivery", b =>
                {
                    ...
                    b.Property<string>("ManualCourierName")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("ManualCourierPhone")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
            ...
            modelBuilder.Entity("MarketTJ.Domain.Entities.OrderCancellation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MarketTJ.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MarketTJ.Domain.Entities.WalletTransaction", b =>
                {
                    b.HasOne("MarketTJ.Domain.Entities.Order", "RelatedOrder")
                        .WithMany()
                        .HasForeignKey("RelatedOrderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MarketTJ.Domain.Entities.Wallet", "Wallet")
