...
public class RefundRequestController(IRefundRequestService service) : ApiControllerBase
{
    [HttpGet]
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateRefundRequestDto dto)
