...
public class CustomerProfileController(ICustomerProfileService service) : ApiControllerBase
{
    [HttpGet]
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateCustomerProfileDto dto)
