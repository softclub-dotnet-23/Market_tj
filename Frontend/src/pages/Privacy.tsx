...
export function Privacy() {
  ...
  const sections = t("pages:privacy.sections", { returnObjects: true }) as LegalSection[];

  return (
    <div>
      <div className="container-page pb-4 pt-8">
        <Breadcrumbs items={[{ label: t("layout:footer.privacy") }]} />
      </div>
      ...
      <section className="container-page pb-8 pt-8 text-center">
        ...
        >
          ...
          <p className="text-balance text-lg text-stone-500 dark:text-stone-400">{t("pages:privacy.subtitle")}</p>
          <p className="text-xs text-stone-400 dark:text-stone-500">{t("pages:privacy.lastUpdated")}</p>
        </motion.div>
      </section>
      ...
      <section className="container-page pb-24">
        ...
        >
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-grove-100 bg-grove-50 p-6 dark:border-grove-900 dark:bg-grove-950/40">
            <h2 className="font-display text-lg text-stone-900 dark:text-stone-50">{t("pages:privacy.contactsTitle")}</h2>
            <p className="text-sm text-stone-600 dark:text-stone-400">{t("pages:privacy.contactsDescription")}</p>
