...
const NAV_ITEMS: AdminNavItem[] = [
  ...
  { labelKey: "documents", path: "/admin/documents", icon: FileText, section: "management" },
  ...
  { labelKey: "blockedAccounts", path: "/admin/blocked-accounts", icon: ShieldOff, section: "management" },
