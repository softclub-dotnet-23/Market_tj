...
const NAV_ITEMS: FarmerNavItem[] = [
  { labelKey: "overview", path: "/farmer", icon: LayoutDashboard, section: "overview" },
  { labelKey: "products", path: "/farmer/products", icon: Package, section: "management" },
  { labelKey: "orders", path: "/farmer/orders", icon: ShoppingCart, section: "management" },
