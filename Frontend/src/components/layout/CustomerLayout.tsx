...
import { Bell, ChevronDown, ChevronsLeft, ChevronsRight, Heart, LayoutDashboard, Leaf, LogOut, MessageCircle, Search, ShoppingBag, ShoppingCart, Store, User as UserIcon } from "lucide-react";
